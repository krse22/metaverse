...
namespace ArcadeVP
{
    public class ArcadeVehicleController : MonoBehaviour
    {
        ...
        [SerializeField] private bool needsPlayer;
        ...
        public void EnterCar(PlayerCarController playerCarController)
        {
            player = playerCarController;
        }

        public void LeaveCar(PlayerCarController playerCarController)
        {
            if (playerCarController == player)
            {
                player = null;
            }
        }
